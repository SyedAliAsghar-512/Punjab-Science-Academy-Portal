...
import { faUser, faUserCircle, faLock, faTachometerAlt, faPlusCircle, faBagShopping, faReceipt, faUserAlt, faStar, faUserPlus } from '@fortawesome/free-solid-svg-icons';
